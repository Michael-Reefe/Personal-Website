...
\usepackage{csquotes}
\usepackage[maxnames=3, minnames=3, style=nature, backend=biber, defernumbers=true]{biblatex}
...
% \\4400 University Dr
% \\Fairfax, VA 22030}
\address{{\it Cell Phone}: +1 (540) 848-4434
\\{\it E-mail}: \hspace{0.5cm} \href{mailto:mreefe@mit.edu}{\color{dkbu} mreefe@mit.edu}
\\{\it Website}: \hspace{0.36cm} \href{https://www.mit.edu/~mreefe/}{\color{dkbu}www.mit.edu/$\sim$mreefe/}}
\address{{\it GitHub}: \hspace{0.1cm} \href{https://github.com/Michael-Reefe}{\color{dkbu} Michael-Reefe}
\\{\it LinkedIn}: \href{https://www.linkedin.com/in/michael-reefe/}{\color{dkbu} Michael Reefe}
\\}
...
\employer{\textit{Poster} \hfill Virtual}
\begin{position}
...
\employer{\textit{iPoster} \hfill Virtual}
\begin{position}
...
% \textbf{Dr. Bryson Cale}{: NASA Jet Propulsion Laboratory, Postdoctoral researcher, Research mentor.}
